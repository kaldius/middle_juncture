...
class Camera:
    ...
    def update_center(self):
        ...
        dx, dy = self.center_goal[0] - self.center_current[0], self.center_goal[1] - self.center_current[1]
    ...
    def zoom_rect(self, rect):
        ...
        self.center_goal[0] = int((rect.right() - rect.left()) * self.trim_horiz + rect.left())
        self.center_goal[1] = int(face_height * self.trim_vert + rect.top())
        self.zoom_goal = self.HEIGHT * self.trim_zoom / face_height
    ...
    def show_face_rect(self, image, pos):
        ...
        cv2.rectangle(image, (pos.left(), pos.top()), (pos.right(), pos.bottom()), (100, 200, 100))
